...
class ActorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create actor" do
    assert_difference("Actor.count") do
      post actors_url, params: { actor: { about_me: @actor.about_me, city: @actor.city, name: @actor.name } }
    end
  ...
  test "should update actor" do
    patch actor_url(@actor), params: { actor: { about_me: @actor.about_me, city: @actor.city, name: @actor.name } }
