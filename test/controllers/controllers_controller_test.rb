...
class ControllersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create controller" do
    assert_difference("Controller.count") do
      post controllers_url, params: { controller: { about_me: @controller.about_me, actor: @controller.actor, city: @controller.city, name: @controller.name } }
    end
  ...
  test "should update controller" do
    patch controller_url(@controller), params: { controller: { about_me: @controller.about_me, actor: @controller.actor, city: @controller.city, name: @controller.name } }
